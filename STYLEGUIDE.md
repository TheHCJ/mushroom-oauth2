...
- You must always use relative imports for imports within the `mushroom_oauth2` (internal imports must
  be relative).
...
Also you can see the latest formatting rules on the [analysis_options.yaml](https://github.com/mastodon-dart/mastodon-oauth2/blob/main/analysis_options.yaml)!
