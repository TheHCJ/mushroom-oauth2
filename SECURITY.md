...
This document outlines security procedures and general policies for the `mushroom_oauth2` project created by `Kato Shinya`.

## 1.1. Reporting a Bug

The team and community take all security bugs in `mushroom_oauth2` seriously.
Thank you for improving the security of `mushroom_oauth2`. We appreciate your efforts and
